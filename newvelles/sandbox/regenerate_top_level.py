...
from newvelles.utils.text import process_content, get_top_words_spacy
...
@click.command()
@click.option('--json_visualization_file', default='./data/visualization_example.json', help='JSON file with visualization data output')
