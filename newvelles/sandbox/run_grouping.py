...
# Removed unused imports: config, debug
...
def main(rss_file):
    ...
    visualization_data, title_groups = build_visualization(title_data)
    print_viz(visualization_data)
    print_sorted_grouped_titles(title_groups)  # Use title_groups instead
